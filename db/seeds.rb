...
raza = User.new(
  first_name: "Raza",
  last_name: "Pirbhai",
  email: "raza@africarriers.co.tz",
  password: "123456",
  location: "HQ",
  admin: "true"
  )
raza.remote_photo_url = 'https://res.cloudinary.com/durtng53m/image/upload/v1594126148/unnamed_5.jpg'
raza.save
...
ladha = User.new(
  first_name: "Mohammed",
  last_name: "Ladha",
  email: "ladha@africarriers.co.tz",
  password: "123456",
  location: "HQ",
  admin: "true"
  )
ladha.remote_photo_url = 'https://res.cloudinary.com/durtng53m/image/upload/v1593673942/WhatsApp_Image_2020-07-01_at_13-removebg-preview.png'
ladha.save
...
sushant = User.new(
  first_name: "Sushant",
  last_name: "Acharjee",
  email: "sushant@africarriers.co.tz",
  password: "123456",
  location: "HQ",
  admin: "true"
  )
sushant.remote_photo_url = 'https://res.cloudinary.com/durtng53m/image/upload/v1593673910/WhatsApp_Image_2020-07-02_at_11-removebg-preview.png'
sushant.save
...
telha = User.new(
  first_name: "Telha",
  last_name: "Ismail",
  email: "telha@africarriers.co.tz",
  password: "123456",
  location: "HQ",
  admin: "true"
  )
telha.remote_photo_url = 'https://res.cloudinary.com/durtng53m/image/upload/v1593673944/WhatsApp_Image_2020-06-30_at_22-removebg-preview.png'
telha.save
